 ...
 * Streams JSON log lines from stdin, skips [INFO]/[DEBUG], and writes valid logs to simulator.json.
...
const fs = require('fs');
const OUTPUT_FILE = 'simulator.json';
...
function processLine(line) {
  line = line.trim();
  if (!line || line.includes('[INFO]') || line.includes('[DEBUG]')) return;
  try {
