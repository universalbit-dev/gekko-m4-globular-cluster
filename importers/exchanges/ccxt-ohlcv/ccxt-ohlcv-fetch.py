...
#import exchange data using ccxt libraries

__author__ = 'Daniel Winter'
__contribution__ = 'UniversalBit'
import ccxt
import time
import math
import argparse
...
#DEFAULT_SINCE
DEFAULT_SINCE = "2023-07-28T00:00:00Z"
...
if __name__ == "__main__":
    try:
        ...
        message("CTRL+C -- Fetcher finished by user --", header='ERROR')
