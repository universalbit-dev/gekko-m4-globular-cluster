...
│   ├── evaluate_results_augmented.json   # Evaluation results augmented
...
│       ├── sma_score.js                  # SMA scoring logic
│       └── adx_score.js                  # ADX scoring logic
...
- **main functional areas**:
  ...
  - **microstructure** & **macrostructure**: Scripts for data at different granularities.
