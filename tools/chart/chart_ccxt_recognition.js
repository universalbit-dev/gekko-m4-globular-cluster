...
const { labelCandle, labelCandles, EPSILON } = require('../train/label_ohlcv.js');
...
const MODEL_DIR = path.resolve(__dirname, '../trained/trained_ccxt_ohlcv');
const OUT_CSV_PATH = path.resolve(__dirname, '../logs/ohlcv_ccxt_data_prediction.csv');
