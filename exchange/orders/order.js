const EventEmitter=require('events');const _=require('lodash');const exchangeUtils=require('../exchangeUtils');const bindAll=exchangeUtils.bindAll;const isValidOrder=exchangeUtils.isValidOrder;const states=require('./states');class BaseOrder extends EventEmitter{constructor(api){super();this.api=api;this.checkInterval=api.interval||1500;this.status=states.INITIALIZING;this.completed=false;this.completing=false;bindAll(this);}
