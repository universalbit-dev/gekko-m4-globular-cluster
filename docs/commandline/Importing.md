...
Import Data from Exchange may not work for some exchanges, for this 
reason inside the History folder it is possible to find some files for backtest your strategy.
